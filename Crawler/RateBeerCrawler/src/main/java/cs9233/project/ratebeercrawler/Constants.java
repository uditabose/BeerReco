...
public interface Constants {
    ...
    interface DIR {
        String DUMP_DIR = "/Users/michaelgerstenfeld/Google Drive/MSCS/FALL14/CS9233/Project/BeerReco/Crawler/DataDump/RateBeer/";
        String RATEBEER = "RateBeer";
        String CITY = "City";
        String BREWERY_BY_CITY = "Brewery-";
